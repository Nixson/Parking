...
var Parking = function(){
    return {
        ...
        getQr: function(){
            var self = this;
            $.post(self.address,{qr: self.uuid},function(data){
                if(data!=''){
                    $('#qr').html('<img class="img-responsive" src="'+data+'" />');
                }
            });
        },
        getPay: function(){
            var self = this;
            $.post(self.address,{pay: self.uuid},function(data){
                if(resp!=''){
                    var balanse = parseFloat(resp);
                    if(typeof balanse=='number')
                        self.balanse = balanse;
...
$(function(){
    ...
    $("#get-pay").on('click',function(){park.getPay();});
